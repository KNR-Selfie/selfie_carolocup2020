...
Point right_delta_offset_strong_point1 (-35, 100);
Point right_delta_offset_strong_point2 (-20, 0);

Point right_delta_offset_low_point1 (-35, 0);
Point right_delta_offset_low_point2 (-20, 100);
Point right_delta_offset_low_point3 (-15, 100);
Point right_delta_offset_low_point4 (-5, 0);

Point center_delta_offset_point1 (-10, 0);
Point center_delta_offset_point2 (-5, 100);
Point center_delta_offset_point3 (5, 100);
Point center_delta_offset_point4 (10, 0);

Point left_delta_offset_low_point1 (5, 0);
Point left_delta_offset_low_point2 (15, 100);
Point left_delta_offset_low_point3 (20, 100);
Point left_delta_offset_low_point4 (35, 0);

Point left_delta_offset_strong_point1 (20, 0);
Point left_delta_offset_strong_point2 (35, 100);
...
Point steering_delta_angle_high_left_point (0, 5);
Point steering_delta_angle_mid_left_point (0, 3);
Point steering_delta_angle_low_left_point (0, 1);
Point steering_delta_angle_center_point (0, 0);
Point steering_delta_angle_low_right_point (0, -1);
Point steering_delta_angle_mid_right_point (0, -3);
Point steering_delta_angle_high_right_point (0, -5);
...
{
  delta_offset = msg.data * 1000 - offset;
...
void addRules()
{
  ...
  r111->addOutput(*steering_angle_high_right);
  ...
  r112->addOutput(*steering_angle_mid_right_cur);
  ...
  r113->addOutput(*steering_angle_low_right_cur);
  ...
  r121->addOutput(*steering_angle_high_right);
  ...
  r122->addOutput(*steering_angle_mid_right_cur);
  ...
  r123->addOutput(*steering_angle_low_right_cur);
  ...
  r131->addOutput(*steering_angle_high_right);
  ...
  r132->addOutput(*steering_angle_mid_right_cur);
  ...
  r133->addOutput(*steering_angle_low_right_cur);
  ...
  r141->addOutput(*steering_angle_mid_right);
  ...
  r142->addOutput(*steering_angle_low_right_cur);
  ...
  r143->addOutput(*steering_angle_center);
  ...
  r151->addOutput(*steering_angle_low_right);
  ...
  r152->addOutput(*steering_angle_center);
  ...
  r153->addOutput(*steering_angle_center);
  ...
  r211->addOutput(*steering_angle_low_right);
  ...
  r212->addOutput(*steering_angle_low_right_cur);
  ...
  r213->addOutput(*steering_angle_center);
  ...
  r221->addOutput(*steering_angle_low_right);
  ...
  r222->addOutput(*steering_angle_low_right_cur);
  ...
  r223->addOutput(*steering_angle_center);
  ...
  r241->addOutput(*steering_angle_center);
  ...
  r242->addOutput(*steering_angle_center);
  ...
  r243->addOutput(*steering_angle_center);
  ...
  r251->addOutput(*steering_angle_low_left);
  ...
  r252->addOutput(*steering_angle_center);
  ...
  r253->addOutput(*steering_angle_low_left_cur);
 ...
 ////////////
  ...
  r311->addOutput(*steering_angle_low_right);
  ...
  r312->addOutput(*steering_angle_low_right_cur);
  ...
  r313->addOutput(*steering_angle_low_right_cur);
  ...
  r343->addOutput(*steering_angle_center);
  ...
  r351->addOutput(*steering_angle_low_left);
  ...
  r352->addOutput(*steering_angle_low_left_cur);
  ...
  r353->addOutput(*steering_angle_low_left_cur);
  ...
  r411->addOutput(*steering_angle_low_right);
  ...
  r412->addOutput(*steering_angle_center);
  ...
  r413->addOutput(*steering_angle_low_right_cur);
  ...
  r421->addOutput(*steering_angle_center);
  ...
  r422->addOutput(*steering_angle_center);
  ...
  r423->addOutput(*steering_angle_center);
  ...
  r433->addOutput(*steering_angle_center);
  ...
  r441->addOutput(*steering_angle_low_left);
  ...
  r442->addOutput(*steering_angle_low_left_cur);
  ...
  r443->addOutput(*steering_angle_center);
  ...
  r451->addOutput(*steering_angle_low_right);
  ...
  r452->addOutput(*steering_angle_low_left_cur);
  ...
  r453->addOutput(*steering_angle_low_right_cur);
  ...
  r511->addOutput(*steering_angle_low_left);
  ...
  r512->addOutput(*steering_angle_center);
  ...
  r513->addOutput(*steering_angle_center);
  ...
  r521->addOutput(*steering_angle_mid_left);
  ...
  r522->addOutput(*steering_angle_low_left_cur);
  ...
  r523->addOutput(*steering_angle_center);
  ...
  r531->addOutput(*steering_angle_high_left);
  ...
  r532->addOutput(*steering_angle_mid_left_cur);
  ...
  r533->addOutput(*steering_angle_low_left_cur);
  ...
  r541->addOutput(*steering_angle_high_left);
  ...
  r542->addOutput(*steering_angle_mid_left_cur);
  ...
  r543->addOutput(*steering_angle_low_left_cur);
  ...
  r551->addOutput(*steering_angle_high_left);
  ...
  r552->addOutput(*steering_angle_mid_left_cur);
  ...
  r553->addOutput(*steering_angle_low_left_cur);
